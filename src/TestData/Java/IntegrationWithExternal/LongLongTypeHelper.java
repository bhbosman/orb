...
/**
* IntegrationWithExternal/LongLongTypeHelper.java .
...
{
  private static String  _id = "IDL:IntegrationWithExternal/LongLongType:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (IntegrationWithExternal.LongLongTypeHelper.id (), "LongLongType", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    IntegrationWithExternal.LongLongType value = new IntegrationWithExternal.LongLongType ();
