...
type CorbaDataOutputStream interface {
	...
	WriteAny(Value __goidl__.IdlAny) (error error)
	...
	WriteLongdouble(Value float64) (error error)
	// Original name: "write_string"
	WriteString(Value string) (error error)
	// Original name: "write_wstring"
	WriteWstring(Value string) (error error)
	// Original name: "write_Object"
	WriteObject(Value *__goidl__.IdlObject) (error error)
	// Original name: "write_Abstract"
	WriteAbstract(Value CorbaAbstractBase) (error error)
	// Original name: "write_Value"
	WriteValue(Value __goidl__.IdlValueBase) (error error)
	...
	WriteFixed(FixedValue __goidl__.IdlAny) (error error)
...
type CorbaDataInputStream interface {
	...
	ReadAny() (result __goidl__.IdlAny, err error)
	...
	ReadLongdouble() (result float64, err error)
	// Original name: "read_string"
	ReadString() (result string, err error)
	// Original name: "read_wstring"
	ReadWstring() (result string, err error)
	// Original name: "read_Object"
	ReadObject() (result *__goidl__.IdlObject, err error)
	// Original name: "read_Abstract"
	ReadAbstract() (result CorbaAbstractBase, err error)
	// Original name: "read_Value"
	ReadValue() (result __goidl__.IdlValueBase, err error)
	...
	ReadFixed(Digits uint16, Scale int16) (result __goidl__.IdlAny, err error)
